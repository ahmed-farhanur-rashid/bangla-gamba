...
PROMPT_BN_TO_EN_FEWSHOT = """নিম্নলিখিত বাংলা বাক্যটি ইংরেজিতে অনুবাদ করুন:

বাংলা: জাতিসংঘ একটি আন্তর্জাতিক সংস্থা।
ইংরেজি: The United Nations is an international organization.

বাংলা: তিনি বিশ্ববিদ্যালয়ে পদার্থবিজ্ঞান নিয়ে পড়াশোনা করছেন।
ইংরেজি: He is studying physics at the university.

বাংলা: এই শহরের জনসংখ্যা দ্রুত বাড়ছে।
ইংরেজি: The population of this city is growing rapidly.

বাংলা: গবেষকরা নতুন একটি ওষুধ আবিষ্কার করেছেন।
ইংরেজি: Researchers have discovered a new medicine.

বাংলা: জলবায়ু পরিবর্তন পৃথিবীর জন্য একটি বড় হুমকি।
ইংরেজি: Climate change is a major threat to the earth.

বাংলা: {source}
ইংরেজি:"""

PROMPT_EN_TO_BN_FEWSHOT = """Translate the following English sentence to Bangla:

English: The United Nations is an international organization.
Bangla: জাতিসংঘ একটি আন্তর্জাতিক সংস্থা।

English: He is studying physics at the university.
Bangla: তিনি বিশ্ববিদ্যালয়ে পদার্থবিজ্ঞান নিয়ে পড়াশোনা করছেন।

English: The population of this city is growing rapidly.
Bangla: এই শহরের জনসংখ্যা দ্রুত বাড়ছে।

English: Researchers have discovered a new medicine.
Bangla: গবেষকরা নতুন একটি ওষুধ আবিষ্কার করেছেন।

English: Climate change is a major threat to the earth.
Bangla: জলবায়ু পরিবর্তন পৃথিবীর জন্য একটি বড় হুমকি।
...
def run_mt_eval(
    ...
    prompt_bn_to_en = PROMPT_BN_TO_EN_FEWSHOT if num_shots > 0 else PROMPT_BN_TO_EN
    prompt_en_to_bn = PROMPT_EN_TO_BN_FEWSHOT if num_shots > 0 else PROMPT_EN_TO_BN
