"""
Rotary Position Embedding (RoPE) for BanglaGamba.

Standard RoPE (Su et al., 2022) with float32 angle computation.
Compatible with GQA — broadcasts over KV heads.

Applied ONLY to Q and K inside GQA attention layers.
NOT applied to Mamba-3 blocks (SSM handles position implicitly).
"""
