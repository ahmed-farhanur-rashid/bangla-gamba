"""
DataLoader builder for BanglaGamba.
...
def ignore_sigint(worker_id):
    ...
    Without this, a Ctrl+C kills worker processes before the main process
    can run its SIGINT handler (which saves an emergency checkpoint).
    """
