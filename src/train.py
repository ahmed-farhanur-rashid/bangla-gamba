"""
BanglaGamba Training Entry Point.
...
# Add BanglaGamba root to path so 'from src.xxx import yyy' works
...
def main():
    ...
    # ── Load configs ──────────────────────────────────────────────────────
    model_config = BanglaGambaConfig.from_yaml(args.model)
    ...
    # ── Build model ───────────────────────────────────────────────────────
    print(f"\n[Init] Building model...")
    model = BanglaGambaModel(model_config).to(device)
    ...
    print(f"[Init]   Attention: {param_counts['attention']:,}")
    print(f"[Init]   Mamba:     {param_counts['mamba']:,}")
    ...
    # ── Train ─────────────────────────────────────────────────────────────
    print(f"\n{'='*70}")
    print(f"  BanglaGamba Training — {trainer_config.run_name}")
