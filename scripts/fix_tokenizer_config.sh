#!/usr/bin/env bash
# Fixes saved/tokenizer/hf/tokenizer_config.json:
...
# Defaults to saved/tokenizer/hf/tokenizer_config.json if no argument given.
...
CONFIG_PATH="${1:-$PROJECT_ROOT/saved/tokenizer/hf/tokenizer_config.json}"
