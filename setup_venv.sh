...
# extensions. GCC 13 is the proven safe compiler for mamba-ssm, flash-attn, etc.
echo ""
echo "=== Step 1: GCC 13 ==="
...
pip uninstall -y \
  mamba-ssm causal-conv1d flash-attn \
...
# ============================================================
# Step 7: mamba-ssm (clone + install — NO setup.py patch needed)
# ============================================================
# With the CUDA header patched in Step 3, the -D_MATHCALLS_H hack in setup.py
# is no longer needed. We install directly from source without any patching.
echo ""
echo "=== Step 7: mamba-ssm from source (Mamba 1/2/3) ==="

MAMBA_SRC="$SCRIPT_DIR/mamba-src"

if [ -d "$MAMBA_SRC" ]; then
  echo "Removing old mamba-src..."
  rm -rf "$MAMBA_SRC"
fi
...
echo "Building and installing mamba-ssm (10-20 min, silence is normal)..."
CC=gcc-13 CXX=g++-13 MAMBA_FORCE_BUILD=TRUE \
...
python -c "from mamba_ssm import Mamba, Mamba2, Mamba3; print('mamba-ssm: Mamba/Mamba2/Mamba3 OK')"

# ============================================================
# Step 8: Flash Attention 2.8.3
# ============================================================
echo ""
echo "=== Step 8: Flash Attention 2.8.3 ==="
...
print("mamba-ssm:      Mamba/Mamba2/Mamba3 OK")
